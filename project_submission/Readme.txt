...
1. 
In the zip file there is a file named "config.properties". Please open the file and replace the values there with valid/correct login credentials to access the NCSU oracle remote database. 
...
After updating the login details in the file, you may follow these steps.

2. By following the below mentioned stpes, please access the remote oracle repository.
...
3. To initialize the database, run the jar file named “initializeDB” using the following command:
```
java -jar initializeDB.jar
